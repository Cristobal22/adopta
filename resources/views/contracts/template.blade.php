...
<head>
    <meta charset="UTF-8">
    <title>Contrato de Adopción Responsable</title>
    <style>
        body {
...
<body>
    ...
    <div class="signatures">
        ...
        <div class="signature-block">
            <p>Firma del Adoptante</p>
            <p style="color: #94a3b8; font-style: italic; margin-top: 15px;">(Firmar físicamente aquí para carga de PDF)</p>
