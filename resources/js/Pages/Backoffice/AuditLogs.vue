      ...
      <main class="main-content">
        ...
        <header class="topbar">
          <div class="logo">
            ...
            <span class="badge-role">Bitácora de Auditoría</span>
          </div>
          <div class="topbar-actions">
            <Link href="/backoffice/contracts-vault" class="btn btn-secondary btn-sm" style="margin-right: 0.5rem;">Bóveda de Contratos</Link>
